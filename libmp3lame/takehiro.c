...
static int
choose_table_nonMMX_with_max(const int *ix, const int *const end, unsigned int max, int *const _s)
{
    ...
    if (cod_info2.block_type == NORM_TYPE)
        ...
        if (i > a1)
            cod_info2.table_select[1] =
                choose_table_nonMMX(ix + a1, ix + i, (int *) &cod_info2.part2_3_length);
