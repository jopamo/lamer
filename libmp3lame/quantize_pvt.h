...
#define Q_MAX (256 + 1)
/*
 * Q_MAX2 is the minimum possible value of:
 *
 ...
 *
 * The minimum is 72 for a long block and 116 for a short block.
 */
#define Q_MAX2 116
...
int calc_xmin(lame_internal_flags const *gfc, III_psy_ratio const *const ratio,
              gr_info *const cod_info, FLOAT *l3_xmin);

int calc_noise(const gr_info *const cod_info, const FLOAT *l3_xmin,
