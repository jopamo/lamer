...
static void avx2_window_mul_f32(FLOAT* dst, FLOAT const* src, FLOAT const* win, int n) {
    int i = 0;
...
static FLOAT avx2_vbr_calc_sfb_noise_x34(FLOAT const* xr, FLOAT const* xr34, unsigned int bw, uint8_t sf) {
...
static void avx2_vbr_quantize_x34(int* l3, FLOAT const* xr34, unsigned int bw, FLOAT sfpow34) {
...
static void avx2_reconstructed_energy_f32(FLOAT const* xr, int const* ix, FLOAT step, int n, FLOAT* source_energy, FLOAT* quant_energy) {
    __m256 const abs_mask = _mm256_castsi256_ps(_mm256_set1_epi32(0x7fffffff));
