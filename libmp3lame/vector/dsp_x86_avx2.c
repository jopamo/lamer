...
static FLOAT
avx2_max_f32(FLOAT const *src, int n)
{
...
static FLOAT
avx2_sum_sq_f32(FLOAT const *src, int n)
{
    __m256 const abs_mask = _mm256_castsi256_ps(_mm256_set1_epi32(0x7fffffff));
    FLOAT tmp[8];
    FLOAT sum = 0.0f;
...
static FLOAT
avx2_dot_f32(FLOAT const *a, FLOAT const *b, int n)
{
    FLOAT tmp[8];
    FLOAT sum = 0.0f;
    int i = 0;
...
static void
avx2_window_mul_f32(FLOAT *dst, FLOAT const *src, FLOAT const *win, int n)
{
    int i = 0;
...
static FLOAT
avx2_vbr_calc_sfb_noise_x34(FLOAT const *xr, FLOAT const *xr34,
...
static void
avx2_vbr_quantize_x34(int *l3, FLOAT const *xr34, unsigned int bw, FLOAT sfpow34)
{
...
static void
avx2_reconstructed_energy_f32(FLOAT const *xr, int const *ix,
                              FLOAT step, int n,
                              FLOAT *source_energy,
                              FLOAT *quant_energy)
{
...
void
lamer_dsp_init_x86_avx2(lamer_dsp *dsp)
{
    dsp->name = "avx2";
