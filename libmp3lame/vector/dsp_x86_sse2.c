...
static void sse2_window_mul_f32(FLOAT *dst, FLOAT const *src, FLOAT const *win,
                                int n) {
  int i = 0;
...
static void sse2_psy_attack_hpf_f32(FLOAT *dst, FLOAT const *src, int n,
                                    FLOAT const *coef) {
  int i = 0;
...
static FLOAT sse2_vbr_calc_sfb_noise_x34(FLOAT const *xr, FLOAT const *xr34,
...
static void sse2_vbr_quantize_x34(int *l3, FLOAT const *xr34, unsigned int bw,
                                  FLOAT sfpow34) {
...
static void sse2_reconstructed_energy_f32(FLOAT const *xr, int const *ix,
                                          FLOAT step, int n,
                                          FLOAT *source_energy,
                                          FLOAT *quant_energy) {
  __m128 const abs_mask = _mm_castsi128_ps(_mm_set1_epi32(0x7fffffff));
