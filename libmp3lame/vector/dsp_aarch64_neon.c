...
static void neon_window_mul_f32(FLOAT *dst, FLOAT const *src, FLOAT const *win,
                                int n) {
  int i = 0;
...
static void neon_psy_attack_hpf_f32(FLOAT *dst, FLOAT const *src, int n,
                                    FLOAT const *coef) {
  int i = 0;
...
static FLOAT neon_vbr_calc_sfb_noise_x34(FLOAT const *xr, FLOAT const *xr34,
...
static void neon_vbr_quantize_x34(int *l3, FLOAT const *xr34, unsigned int bw,
                                  FLOAT sfpow34) {
  FLOAT x[4];
  unsigned int i = bw >> 2u;
  unsigned int const remaining = bw & 0x03u;
...
static void neon_reconstructed_energy_f32(FLOAT const *xr, int const *ix,
                                          FLOAT step, int n,
                                          FLOAT *source_energy,
                                          FLOAT *quant_energy) {
