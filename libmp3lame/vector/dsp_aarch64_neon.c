...
static int neon_experimental_quant_simd_enabled(void) {
...
static void neon_abs_f32(FLOAT* dst, FLOAT const* src, int n) {
    int i = 0;
...
static FLOAT neon_abs_max_f32(FLOAT const* src, int n, FLOAT floor) {
...
static FLOAT neon_max_f32(FLOAT const* src, int n) {
...
static FLOAT neon_sum_sq_f32(FLOAT const* src, int n) {
    FLOAT tmp[4];
    FLOAT sum = 0.0f;
    int i = 0;
...
static FLOAT neon_dot_f32(FLOAT const* a, FLOAT const* b, int n) {
    FLOAT tmp[4];
    FLOAT sum = 0.0f;
    int i = 0;
...
static void neon_window_mul_f32(FLOAT* dst, FLOAT const* src, FLOAT const* win, int n) {
    int i = 0;
...
static void neon_scalar_k_34_4(FLOAT x[4], int l3[4]) {
    l3[0] = (int)x[0];
    l3[1] = (int)x[1];
    l3[2] = (int)x[2];
    l3[3] = (int)x[3];
...
static FLOAT neon_vbr_calc_sfb_noise_x34(FLOAT const* xr, FLOAT const* xr34, unsigned int bw, uint8_t sf) {
    FLOAT x[4];
    int l3[4];
...
static void neon_vbr_quantize_x34(int* l3, FLOAT const* xr34, unsigned int bw, FLOAT sfpow34) {
    FLOAT x[4];
    unsigned int i = bw >> 2u;
    unsigned int const remaining = bw & 0x03u;
...
static void neon_reconstructed_energy_f32(FLOAT const* xr, int const* ix, FLOAT step, int n, FLOAT* source_energy, FLOAT* quant_energy) {
