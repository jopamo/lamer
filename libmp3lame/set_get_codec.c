...
int lame_set_experimental_short_transient_redistribute(
    lame_global_flags *gfp, int experimental_short_transient_redistribute) {
  if (is_lame_global_flags_valid(gfp)) {
    gfp->experimental_short_transient_redistribute =
        experimental_short_transient_redistribute;
    return 0;
  }
  return -1;
}

int lame_get_experimental_short_transient_redistribute(
...
int lame_set_safe_short_transient_redistribute(
    lame_global_flags *gfp, int safe_short_transient_redistribute) {
  if (is_lame_global_flags_valid(gfp)) {
